'''Main Script to run, this handles commands for generating the static webpage
    and populating the data store'''
...
sin_city = media.Movie(
    "Sin City",
    ("Sin City is a 2005 American neo-noir crime anthology film written, "
     "produced, and directed by Frank Miller and Robert Rodriguez."),
...
star_wars = media.Movie(
    ...
    ("It depicts the adventures of various characters 'a long time ago in a"
     " galaxy far, far away'"),
...
v_vendatta = media.Movie(
    "V For Vendatta",
    ("V for Vendetta is a 2005 dystopian political thriller film set in an "
     "alternative future where a neo-fascist regime has subjugated the United"
     " Kingdom."),
...
pulp_fiction = media.Movie(
    "Pulp Fiction",
    ("Pulp Fiction is a 1994 American black comedy neo-noir crime film that "
     "connects the intersecting storylines of Los Angeles mobsters, fringe "
     "players, small-time criminals, and a mysterious briefcase."),
